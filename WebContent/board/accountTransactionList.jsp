...
<header>
	<div
		class="jumbotron jumbotron-fluid mb-5 border-bottom-0 rounded-bottom text-white bg-info"
...
function foo(){
    ...
    for(var i = 0; i < data.length;i++){
    	...
    	if(dataMonth==month){
    		...
    		var cardBody = $('#canvas').append('<div id="card'+index+'" class="card mx-auto border-dark bg-dark" style="max-width: 700px;"><div class="card-body row"></div></div>');
			...
			var cardBodyUl_li2 = cardBodyUl.children('ul').append('<li class="list-inline-item ml-3"><div style="color: white; vertical-align: middle; font-size: 1em;">'
